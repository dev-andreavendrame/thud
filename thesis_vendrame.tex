...
\chapter{Implementation - Initial prototype}
...
After providing a brief introduction, the following sections will delve into the details of how the initial prototype of Truthster is implementing its basic functionalities. Additionally, we will identify the missing components and explain how we plan to address them in order to meet both the functional and non-functional requirements of the system. Through this process, we aim to develop a comprehensive and reliable platform that can effectively address the needs of the journalism industry and provide a trustworthy and transparent source of information to the general public.
