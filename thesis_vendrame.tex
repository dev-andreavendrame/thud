...
\cosupervisor{Dott. Ivan Mercanti}
...
This information and the recorded media from the \nameref{mediaGetting} scenario are sent to the back end, where a new project is created and stored in the platform’s database. With the current prototype, we can create a new project and specify the required interview details, but the user cannot login to the platform yet.
