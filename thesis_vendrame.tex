...
At the beggining, the Truthster backend should firstly load its private key, create an AT (Alastria Token), sign it and sends it to Bob. Then Bob loads his private key (locally stored), creates and AIC (Alastria Identity Creation), signs it and sends it to the Truthster backend. After that Truthster should decode it and verify the signature with the public key of Bob.
