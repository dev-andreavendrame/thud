...
\begin{itemize}
    ...
    \item \textbf{Digital Signature}: is a method for ensuring the authenticity and integrity of digital content. It uses encryption and hashing algorithms in order to create a unique digital fingerprint of the content, called a signature, which can be used to verify its authenticity. In Truthster digital signatures can be used to authenticate the identity of the interviewer and interviewee and to ensure that the content of the interview has not been tampered with.
